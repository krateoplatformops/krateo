...
func Install(rc *rest.Config, opts *InstallOptions) error {
	rg := newRESTClientGetter(rc, opts.Namespace)
...
func Uninstall(rc *rest.Config, opts *UninstallOptions) error {
	rg := newRESTClientGetter(rc, opts.Namespace)
